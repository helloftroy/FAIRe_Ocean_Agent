...
_EXPLICIT_RULES: tuple[MappingRule, ...] = (
    ...
    MappingRule("targeted_detection_method", EntityLevel.STUDY.value, "projectMetadata",
                "targeted_detection_method", MappingMethod.SUGGESTED_SEMANTIC.value, review_required=True),
    MappingRule("probe_name", EntityLevel.STUDY.value, "projectMetadata", "probe_name",
                MappingMethod.SUGGESTED_SEMANTIC.value, review_required=True),
    MappingRule("probe_target_taxon", EntityLevel.STUDY.value, "projectMetadata", "probe_target_taxon",
                MappingMethod.SUGGESTED_SEMANTIC.value, review_required=True),
